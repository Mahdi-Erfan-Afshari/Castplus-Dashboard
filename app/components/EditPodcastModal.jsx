...
const EditPodcastModal = ({ sendPodcastModalRef, podcastId, setLoading }) => {
	...
	return (
		<>
			<div ref={editPodcastModalRef} id="edit-podcast-modal" className="hidden fixed top-0 left-0 flex justify-center items-center w-full h-full bg-transparent-black-50 ms-0 z-30 ltr" onClick={documentClickCloseModal}>
