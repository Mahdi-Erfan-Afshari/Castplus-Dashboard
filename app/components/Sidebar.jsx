...
const Sidebar = () => {
  ...
  return (
	<>
	<div className='fixed top-5 left-5 p-2 cursor-pointer' onClick={toggleSidebar}>
		<HiMenuAlt2 className='text-2xl' />
	</div>
	<div id='sidebar' className={`${nunito.className} ${'fixed top-0 left-0 flex flex-col bg-white w-0 md:w-72 h-full shadow-lg duration-200'}`}>
		...
		<div className='flex flex-col justify-between h-full px-2 my-6'>
